...
being able to see my surroundings, I see the entrance to a big cavern. As I approach it and turn to see what is inside, my eyes fall upon Drakara.
''', font = font01, background_color = '#4B3619')
btn001 = sg.Button ('Enter', font = font01, key = 'BTN001')

layout_frm_01 = [[img01], [txt001], [btn001]]
frm001 = sg.Frame('', layout_frm_01, size=(1920,1080), element_justification = 'c', background_color = '#4B3619', key = 'FRM001')
#############################################################

################# Frame 0 ###############################
img05 = sg.Image ('221.png')
...
layout_frm_3 = [[img08], [txt05], [txt06, sld03, img04], [txt_empty_3], [btn03]]
...
layout = [[frm001, frm002, frm01, frm02, frm03, frm04]]
